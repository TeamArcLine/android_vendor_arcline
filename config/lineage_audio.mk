...
ALARM_PATH := vendor/arcline/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/arcline/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/arcline/prebuilt/common/media/audio/ringtones
